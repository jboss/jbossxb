 ...
 *
 * <p><code>public Object getRoot()</code>
 ...
 *
 * <p>a set of <code>getChildren()</code> methods.
 ...
 *     For the root element the object returned by the <code>getRoot()</code> is passed as the parent.</li>
 * <li>the third one is the namespace URI of the child element.</li>
 * <li>the forth one is the local name of the child element.</li>
 * </ol>
 * A <code>getChildren()</code> method returns children according to the namespace URI and local name.
 ...
 *
 * <p>A set of <code>getElementValue()</code> methods.
 ...
 *
 * <p>A set of <code>getAttributeValue()</code> methods.
