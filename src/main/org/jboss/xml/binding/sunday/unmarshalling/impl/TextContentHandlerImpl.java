 ...
 */
public class TextContentHandlerImpl
   implements TextContentHandler
{
   private TextContentHandler next;

   public TextContentHandler getNext()
   {
      return next;
   }

   public void setNext(TextContentHandler handler)
   {
      this.next = handler;
   }
