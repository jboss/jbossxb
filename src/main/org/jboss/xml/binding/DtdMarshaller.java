...
{
   private static final Category log = Category.getInstance(DtdMarshaller.class);
   ...
   private DTD dtd;
   private org.jboss.xml.binding.ObjectModelProvider provider;
   private org.jboss.xml.binding.Content content = new org.jboss.xml.binding.Content();
   ...
   public void marshal(Reader dtdReader, org.jboss.xml.binding.ObjectModelProvider provider, Writer writer)
      throws IOException, SAXException
   {
      marshal(dtdReader, provider, provider.getDocument(), writer);
   }

   public void marshal(Reader dtdReader, org.jboss.xml.binding.ObjectModelProvider provider, Object document, Writer writer)
      throws IOException, SAXException
   {
      ...
      org.jboss.xml.binding.ContentWriter contentWriter = new org.jboss.xml.binding.ContentWriter(writer);
   ...
   private final void handleElement(DTD dtd, DTDElement element, Attributes attrs)
   {
      ...
      {
         org.jboss.xml.binding.ObjectModelProvider provider = getProvider(systemId, this.provider);
      ...
      if(children != null)
      {
         ...
         if(!el.started)
         {
            ...
            while(firstNotStarted < elementStack.size())
            {
               ...
               log.info("starting skipped> " + notStarted.getName());
